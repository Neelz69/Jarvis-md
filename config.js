...
const DATABASE_URL = process.env.DATABASE_URL === undefined ? "mongodb+srv://RavinduNethsara:<db_password>@cluster0.tbytw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" : process.env.DATABASE_URL
